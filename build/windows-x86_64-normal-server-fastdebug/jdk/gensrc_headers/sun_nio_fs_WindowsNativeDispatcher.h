 ...
 * Class:     sun_nio_fs_WindowsNativeDispatcher
 * Method:    BackupRead0
 * Signature: (JJIZJLsun/nio/fs/WindowsNativeDispatcher/BackupResult;)V
 */
JNIEXPORT void JNICALL Java_sun_nio_fs_WindowsNativeDispatcher_BackupRead0
  (JNIEnv *, jclass, jlong, jlong, jint, jboolean, jlong, jobject);

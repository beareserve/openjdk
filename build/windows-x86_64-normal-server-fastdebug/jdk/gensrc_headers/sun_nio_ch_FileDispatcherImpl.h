 ...
 * Class:     sun_nio_ch_FileDispatcherImpl
 * Method:    writev0
 * Signature: (Ljava/io/FileDescriptor;JIZ)J
 */
...
/*
 * Class:     sun_nio_ch_FileDispatcherImpl
 * Method:    closeByHandle
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_sun_nio_ch_FileDispatcherImpl_closeByHandle
  (JNIEnv *, jclass, jlong);
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_sun_nio_ch_FileDispatcherImpl_duplicateHandle
  (JNIEnv *, jclass, jlong);
